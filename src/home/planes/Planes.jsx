...
const Planes = () => {
  return (
    <div>
        <h2 className="text-white text-center fw-bold my-5">Nuestra veterinaria actualmente ofrece un servicio especial mensual para nuestras mascotas al
estilo de una obra social, por lo que cuenta con 3 planes:</h2>
      <Container>
        ...
        <Col sm={12} md={6} className="mt-2">
            <h3 className="text-warning fw-bold">Plan Primeros Pasos</h3>
            ...
            <Link to="/PaginaPlanes" className="btn-consulta text-decoration-none text-center">Consultar </Link>
          </Col>
          ...
          <Col sm={12} md={6}className="mt-2">
            <h3 className="text-warning fw-bold ">Plan Madurando</h3>
          ...
          <Col sm={12} md={6} className="mt-2">
            <h3 className="text-warning fw-bold">Plan Adultos</h3>
            ...
            <Link to="/PaginaPlanes" className="btn-consulta text-decoration-none text-center">Consulta </Link>
          </Col>
